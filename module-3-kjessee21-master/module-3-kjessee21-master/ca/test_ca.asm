#
# Test binary_calculator with some examples
#
...
# s4 - output word
#
# binary_calculator must:
# - be named binary_calculator and declared as global
...
run_test:
        ...
        jal     binary_to_dec          # call subroutine under test
